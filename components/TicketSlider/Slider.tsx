        ...
        <div className="absolute inset-0 z-50 ">
          <div className="h-full flex flex-col md:flex-row">
            <div className="w-full md:w-3/7 pl-20 flex flex-row justify-center items-center">
              <h2 className="slider-title text-black font-black text-xl md:text-5xl text-balance">
                Super precio
              </h2>
            </div>
        ...
        <div className="absolute inset-0  z-50">
          <div className="h-full flex flex-col md:flex-row ">
            <div className="w-full md:w-3/7 pl-20 flex flex-col justify-center items-center">
              <h2 className="slider-title font-black text-xl md:text-5xl text-balance">
                Super precio
              </h2>
            </div>
            <div className="w-full md:w-4/7 border-l-4 border-primary border-dashed">
